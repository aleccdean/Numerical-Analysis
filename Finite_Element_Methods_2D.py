...
import report1.prolongation_matrix as prolongation_matrix
...
def main(node, ele): #Inputs: F(x,y) (right hand side function), domain(omega), node file, element file,
...
def unknown_h1_error(node1, ele1, node2, ele2):
  #H1-error
  A_global1, b1, _ = main(node1, ele1)
  A_global2, b2, _ = main(node2, ele2)
...
def compute_unkown_error(node1, ele1, node2, ele2):
  u1, b1, basis_functions1 = main(node1, ele1)
  u2, b2, basis_functions2 = main(node2, ele2)
